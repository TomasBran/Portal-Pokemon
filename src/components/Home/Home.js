        ...
        <div className='home-container'>
            <div className='home-panel'>
                ...
                <div className='home-button-container'>
                    ...
                    <Link className='no-underline' to="/gym"><button className='home-button gym-button'><span className='home-button-text'>Gimnasio</span></button></Link>
                    ...
                    <Link className='no-underline' to="/moveset"><button className='home-button moveset-button'><span className='home-button-text'>Adivina el MoveSet (WIP)</span></button></Link>
