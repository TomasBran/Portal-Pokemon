...
const DraggableItem = ({ id, name, shortenText }) => {
  ...
  return (
    <div
      ref={drag}
      className={`border text-xs border-gray-300 p-2 m-2 cursor-move min-w-[8%] min-h-[4vh] flex justify-center items-center text-white font-medium rounded-lg active:scale-90 gap-1 ${name.toLowerCase()}`}
    >
      <img
